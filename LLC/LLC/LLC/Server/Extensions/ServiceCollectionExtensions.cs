...
using LLC.Infrastructure.Repositories;
using LLC.Infrastructure.Services;
using LLC.Infrastructure.Services.Identity;
using LLC.Infrastructure.Shared.Services;
using LLC.Server.Permission;
using LLC.Server.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\LLC.Server.xml", System.AppDomain.CurrentDomain.BaseDirectory));
